<aside class="w-[17%] h-screen bg-gray-50 border-r border-gray-200 flex flex-col shadow-sm fixed top-0 left-0" id="navBar">
    <div class="p-6 flex items-center justify-between">
        <div class="flex items-center gap-2 block" id="site_name">
            <img src="/assets/picture/logo.png" alt="logo" class="w-12">
