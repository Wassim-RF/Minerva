        ...
        <div class="bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 flex flex-col">
            ...
            <div class="p-6 flex flex-col flex-grow">
                ...
                <p class="text-slate-400 text-sm mb-4">
                    <?= htmlspecialchars($class['description'] ?? 'Aucune description') ?>
                </p>

                <div class="flex items-center text-slate-400 text-sm mb-6">
                    <i class="fa-solid fa-users mr-2"></i>
                    <?= $class['student_count'] ?> étudiants
                </div>

                <div class="flex gap-3 mt-auto">
                    <button class="flex-grow bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold py-3 rounded-xl transition">
                        Voir détails
                    </button>
